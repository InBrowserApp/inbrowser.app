<template>
  <div>
    ...
    <n-p>
      <div v-if="isValid">
        <router-link :to="decodeUUIDPath" class="decode-uuid-link">
    ...
    <WhatIsUUID />
    <RelatedTools :tools="relatedTools" hide="uuid-validator" />
  </div>
</template>
...
import { NH1, NP, NH2, NIcon } from 'naive-ui'
...
const { path: decodeUUIDPath } = useSiteLanguagePath(
  computed(() => '/tools/uuid-decoder/' + uuid.value),
)
