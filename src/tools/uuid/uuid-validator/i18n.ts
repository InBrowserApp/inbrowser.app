export const meta = {
  ...
  ja: {
    name: 'UUID バリデーター',
    description:
      'UUID を検証し、UUID 仕様に準拠しているかどうかを確認します。UUID の形式とバージョンを検証し、RFC 4122 に従って有効であることを確認します。',
  },
  ko: {
    name: 'UUID 검증기',
    description:
      'UUID를 검증하고 UUID 사양을 준수하는지 확인합니다. UUID 형식과 버전을 검증하고 RFC 4122에 따라 유효한지 확인합니다.',
  },
  ru: {
    name: 'Валидатор UUID',
    description:
  ...
  th: {
    ...
    description:
      'ตรวจสอบ UUID และตรวจสอบว่าตรงตามข้อกำหนด UUID หรือไม่ ตรวจสอบรูปแบบ UUID เวอร์ชัน และตรวจสอบให้แน่ใจว่าถูกต้องตาม RFC 4122',
  },
  id: {
    name: 'Validator UUID',
    description:
      'Validasi UUID dan periksa apakah sesuai dengan spesifikasi UUID. Verifikasi format UUID, versi, dan pastikan valid menurut RFC 4122.',
  },
  he: {
  ...
  ms: {
    name: 'Pengesah UUID',
    description:
      'Sahkan UUID dan periksa sama ada ia mematuhi spesifikasi UUID. Sahkan format UUID, versi, dan pastikan ia sah mengikut RFC 4122.',
  },
  no: {
