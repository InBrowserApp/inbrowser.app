export const toolID = 'sha256-hash-text-or-file'
export { Hash as icon } from '@shared/icons/tabler'
export const path = '/tools/sha256-hash-text-or-file'
export const tags = ['hash', 'sha256', 'checksum', 'security', 'file', 'text', 'crypto']
