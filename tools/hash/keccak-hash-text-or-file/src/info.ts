export const toolID = 'keccak-hash-text-or-file'
export { Hash as icon } from '@shared/icons/tabler'
export const path = '/tools/keccak-hash-text-or-file'
export const tags = ['hash', 'keccak', 'checksum', 'security', 'file', 'text', 'crypto']
