export const toolID = 'sha1-hash-text-or-file'
export { Hash as icon } from '@shared/icons/tabler'
export const path = '/tools/sha1-hash-text-or-file'
export const tags = ['hash', 'sha1', 'checksum', 'security', 'file', 'text', 'crypto']
