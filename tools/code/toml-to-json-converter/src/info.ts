...
export const meta = {
  en: {
    ...
    description: 'Convert TOML to JSON. Paste TOML or import a file; preview, copy, and download.',
  },
  zh: {
    name: 'TOML 转 JSON 转换器',
    description: '将 TOML 转为 JSON。粘贴 TOML 或导入文件；预览、复制并下载。',
  },
  'zh-CN': {
    name: 'TOML 转 JSON 转换器',
    description: '将 TOML 转为 JSON。粘贴 TOML 或导入文件；预览、复制并下载。',
  ...
  'zh-TW': {
    ...
    description: '將 TOML 轉為 JSON。貼上 TOML 或匯入檔案；預覽、複製並下載。',
  },
  'zh-HK': {
    name: 'TOML 轉 JSON 轉換器',
    description: '將 TOML 轉為 JSON。貼上 TOML 或匯入檔案；預覽、複製並下載。',
  ...
  ko: {
    name: 'TOML → JSON 변환기',
    description:
      'TOML을 JSON으로 변환합니다. TOML 붙여넣기 또는 파일 가져오기; 미리보기, 복사, 다운로드.',
  },
  ru: {
  ...
  ar: {
    name: 'محول TOML → JSON',
    description: 'حوّل TOML إلى JSON. الصق TOML أو استورد ملفًا؛ معاينة ونسخ وتنزيل.',
  },
  hi: {
  ...
  tr: {
    ...
    description:
      'TOML’i JSON’a dönüştürün. TOML yapıştırın veya dosya içe aktarın; önizleme, kopyalama ve indirme.',
  },
  nl: {
    name: 'TOML → JSON-converter',
    description:
  ...
  vi: {
    ...
    description: 'Chuyển TOML sang JSON. Dán TOML hoặc nhập tệp; xem trước, sao chép và tải xuống.',
  },
  th: {
    name: 'ตัวแปลง TOML → JSON',
    description: 'แปลง TOML เป็น JSON วาง TOML หรือ นำเข้าไฟล์; ดูตัวอย่าง คัดลอก และดาวน์โหลด',
  },
  id: {
  ...
  he: {
    name: 'ממיר TOML → JSON',
    description: 'המרת TOML ל‑JSON. הדביקו TOML או ייבאו קובץ; תצוגה מקדימה, העתקה והורדה.',
  },
  ms: {
