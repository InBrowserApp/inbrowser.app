...
export const toolID = 'json-formatter'
export const path = '/tools/json-formatter'
export const tags = ['code', 'json', 'formatter', 'prettifier']
...
export const meta = {
  ...
  zh: {
    name: 'JSON 格式化器',
    description: '格式化和美化JSON，并提供正确的缩进。粘贴JSON或导入文件；预览、复制并下载。',
  },
  'zh-CN': {
    name: 'JSON 格式化器',
    description: '格式化和美化JSON，并提供正确的缩进。粘贴JSON或导入文件；预览、复制并下载。',
  ...
  'zh-TW': {
    name: 'JSON 格式化器',
    description: '格式化和美化JSON，並提供正確的縮進。貼上JSON或匯入檔案；預覽、複製並下載。',
  },
  'zh-HK': {
    name: 'JSON 格式化器',
    description: '格式化和美化JSON，並提供正確的縮進。貼上JSON或匯入檔案；預覽、複製並下載。',
  ...
  ar: {
    name: 'منسق JSON',
    description: 'نسق وجمّل JSON بالإزاحة المناسبة. الصق JSON أو استورد ملفًا؛ معاينة ونسخ وتنزيل.',
  },
  hi: {
    name: 'JSON फॉर्मेटर',
    description:
