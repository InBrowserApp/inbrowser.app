import type { SupportedLanguage } from '@shared/locale/languages'
...
export interface ToolInfo {
  ...
  /**
   * Whether the tool is external
   * @type {boolean}
   */
  readonly external?: boolean

  /**
   * Whether the tool is third party
   * @type {boolean}
   */
  readonly thirdParty?: boolean

  /**
   * Whether the tool is a collection of tools
   * @type {boolean}
   */
